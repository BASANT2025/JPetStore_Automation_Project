...
@Parameters({"owner"})
public class T10_E2E_Scenario_Positive2 {
    WebDriver driver;
    P00_Home_Page home;
    P01_Login Login;
    ...
    @Description("Login-->Navigate To Product Page-->Add item to cart-->change Quantity-->Checkout-->Confirm Order Details-->Delete Order")
    @Test
    //Login-->Navigate To Product Page-->Add item to cart-->change Quantity-->Checkout-->Confirm Order Details-->Delete Order
    ...
    public void E2EScenario(){
       ...
       Assert.assertEquals(Category.pageTitle(),"Fish");
        ...
        orderForm.selectCardType("MasterCard")
                ...
                .confirmOrder()
                .confirmOrderDetails().deleteOrder();
        U01_BaseClass.takeScreenshot(driver,"Successful Deleted Order Scenario");

        Assert.assertEquals(driver.getCurrentUrl(),"https://jpetstore.aspectran.com/order/listOrders");
    }
